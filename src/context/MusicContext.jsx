...
export function MusicProvider({ children }) {
  ...
  return (
    <MusicContext.Provider value={{
      songs: mockSongs, currentSong, isPlaying, currentTime, duration, volume, shuffle, repeat,
      playlists, likedIds, recentlyPlayed, theme, isSearching, playSong, togglePlay,
      playNext, playPrev, seekTo, setVolume, setShuffle, setRepeat, toggleLike, isLiked,
      createPlaylist, deletePlaylist, renamePlaylist, addToPlaylist, removeFromPlaylist,
      toggleTheme, searchResults, searchSongs
    }}>
      {children}
